...
**Important Note:** *This article is strongly connected to an external particle tool and tutorial collection and most links will guide you there: [Github](https://github.com/Nibuja05/dota_particle_editor_tutorial).*
...
- The [Function Library](https://github.com/Nibuja05/dota_particle_editor_tutorial/blob/master/Function%20Library.md), a collection of all known functions with their usage and other useful information.
