...
Here's a step by step guide to custom sound events.
...
## Step 2. Copy/Move the file to the content folder
...
## Step 3. The Custom Sounds Valve Event

Also inside the content folder of your addon, there should be a soundevents folder:
