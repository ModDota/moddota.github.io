...
I'm glad you asked. 
- To start off, [grab the code](https://pastebin.com/M1E2zjku) then it that into a lua file you've put somewhere in your vscripts folder. That is your `modifier_generic_barrier` class file. It's important to remember where you put it, because you'll need to know what the path is.
